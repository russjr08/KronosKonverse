...
public class KonverseAPI {
    public static final Version API_VERSION = new Version().setProtocol("2.1-BETA").setReadable("2.1 Beta");
    ...
    public static final String AUTHENTICATION_ACCOUNT_DISABLED = "Account is disabled.";
